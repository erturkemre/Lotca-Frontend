...
import { useRegister, useRegistrationStatus } from '../../features/auth/useAuth'
...
export default function Register() {
  ...
  const registrationClosed = status?.enabled === false
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-bg">
      <div className="w-full max-w-sm rounded-lg bg-white p-6 shadow-sm">
        ...
        {!statusLoading && registrationClosed ? (
          <p className="rounded bg-gray-100 px-3 py-3 text-center text-sm text-gray-600">
            Yeni kayıtlar şu anda kapalı. Lütfen daha sonra tekrar deneyin.
          </p>
        ) : (
